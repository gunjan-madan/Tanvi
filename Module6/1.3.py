...
#Call the function
print("Student Details are ", studentDetails("Tanvi",12345, 14, "Charlotte", "High school"))
...
# print("Average: **kwargs")
# funny = fun(first = 10, second = 20, third = 30, fourth = 40, fifth = 50)
# print("Average: ", funny)
